...
var Player = Sprite.extend({
    ...
    _createBubble: function (onscreenSprites) {
        ...
        if (this._playerAnimations.prefix === 'bub') {
            var playerNum = 1;
        }
        else {
            var playerNum = 2;
        }
        onscreenSprites.bubbles.push(new Bubble(onscreenSprites.bubbles.length + 1, x, this.y, this._playerAnimations.direction, playerNum));
    },
